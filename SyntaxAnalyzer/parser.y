...
/* Enable Bison's detailed reduction error reporting (e.g., "expecting ';'") */
...
stmt:
    ...
    | funcdef 
    | ';' 
    /* Error recovery: if a statement has a syntax error, skip until the next semicolon to continue parsing */
    | error ';' { yyerrok; }
    ;
